...
import hbmodel.AuthenticationService;

/**
 * Servlet implementation class HBLoginServlet
 */
@WebServlet("/hbLoginServlet")
public class HBLoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(request.getParameter("username").equals("") && request.getParameter("username").equals("")) {
				...
				if(AuthenticationService.valideateUserHB(request.getParameter("username"),
