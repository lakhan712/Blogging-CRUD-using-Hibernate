...
import hbmodel.HBUpdateService;

/**
 * Servlet implementation class PostUpdateServlet
 */
@WebServlet("/hbPostUpdateServlet")
public class HBPostUpdateServlet extends HttpServlet {
...
//			System.out.println("Post data: "+request.getParameter("postdata"));
			...
			if (HBUpdateService.updatePost(request.getParameter("post"), Integer.parseInt(request.getParameter("id")))) {
